...
import cn.zhaoyb.zcore.R;
import cn.zhaoyb.zcore.uploadimage.listener.impl.ImageUploadProgressListener;
import cn.zhaoyb.zcore.uploadimage.listener.IUploadRetryListener;
import cn.zhaoyb.zcore.uploadimage.listener.IUploadViewDisplay;
import cn.zhaoyb.zcore.uploadimage.utils.BitmapCompressManager;
import cn.zhaoyb.zcore.uploadimage.utils.ThreadPool;
...
public class SimpleUploadView extends FrameLayout implements IUploadViewDisplay {
    ...
    /** 用于重试的回调*/
    private IUploadRetryListener retryListener;
    ...
    public void setOnRetryListener(IUploadRetryListener retryListener) {
